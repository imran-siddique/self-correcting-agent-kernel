% Self-Correcting Agent Kernel - ANONYMIZED VERSION
% Target: NeurIPS 2026 / ICML 2026 (Double-Blind Review)
% Compile: pdflatex anonym_main.tex && bibtex anonym_main && pdflatex anonym_main.tex && pdflatex anonym_main.tex
% arXiv compatible: Yes

\pdfoutput=1  % Required for arXiv PDF submission
...
\usepackage{lmodern}  % Scalable fonts (arXiv compatible)
...
% ===== Hyperref (must be loaded last for arXiv compatibility) =====
...
\hypersetup{
    ...
    pdfauthor={Anonymous},
    pdfkeywords={AI agents, self-correction, memory management, LLM},
...
% NOTE: Self-citation removed for anonymous review
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.95\textwidth]{fig1_ooda_architecture.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.95\textwidth]{fig2_memory_hierarchy.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.9\textwidth]{fig3_gaia_results.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.9\textwidth]{fig5_context_reduction.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.75\textwidth]{fig6_mttr_boxplot.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.95\textwidth]{fig4_ablation_heatmap.pdf}
...
We will release our implementation, datasets, and reproducibility package upon acceptance.\footnote{Code and data will be made available at publication time.}
...
Docker images with pinned dependencies will be provided for exact reproduction upon acceptance.
